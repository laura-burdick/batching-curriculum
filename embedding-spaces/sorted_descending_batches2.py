...
# Descending curriculum, cumulative batching
...
name = '_sorted_descending_batches2_'+str(numBatches)+'_'
...
print('Sorting')
sentences = sorted(sentences,key=lambda sentence: len(sentence),reverse=True)
